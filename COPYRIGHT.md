...
- Database structures and designs
...
- Use must comply with all applicable agreements and regulatory requirements
- Any redistribution, sublicensing, or transfer is strictly prohibited

### Restrictions
- No source code modification or reverse engineering is permitted
- No derivative works may be created or distributed
- No commercial use is permitted without explicit written authorization
- No copying, rental, leasing, or lending is permitted

## Regulatory Compliance

This software is designed for use in Kazakhstan and complies with:
- **ARRF (Agenstvo regulyatsii i razvitiya finansovogo rynka)** requirements
...
- **Solvency 2** regulatory framework (as applicable)
- Kazakhstan banking and insurance regulations

## Third-Party Libraries

This software incorporates third-party open-source libraries, each governed by their respective licenses. See `requirements.txt` and package documentation for details on:
- Flask and extensions
- SQLAlchemy and Prisma
- NumPy, SciPy, Pandas
- Other open-source dependencies

Use of these libraries is permitted under their respective licenses (MIT, Apache 2.0, BSD, etc.).

## Confidentiality

The proprietary algorithms, calculation methodologies, and business logic contained in this software are confidential trade secrets of Alliot Systems.
...
| Date | Version | Change |
|------|---------|--------|
| 2025-12-02 | 3.0.0 | Initial copyright notice |

---

**Last Updated:** December 2, 2025
**Status:** Active - Proprietary License
